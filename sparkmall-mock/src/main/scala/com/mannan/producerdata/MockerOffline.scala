package com.mannan.producerdata

import java.text.SimpleDateFormat
import java.util.{Date, Properties, UUID}

import com.mannan.sparkmall.common.model.DataModel.{CityInfo, ProductInfo, UserInfo, UserVisitAction}
import com.mannan.sparkmall.common.util.PropertiesUtil
import com.mannan.util.RandomOptions.RanOpt
import com.mannan.util.{RandomDate, RandomNum, RandomOptions}
...
object MockerOffline {
  ...
  def insertHive(sparkSession: SparkSession,tableName:String,dataFrame:DataFrame): Unit ={
    ...
    val databases: String = properties.getProperty("hive.database")
    sparkSession.sql("use " +databases)
  ...
  def mockUserAction()={
    ...
    val startDate: Date = new   SimpleDateFormat("yyyy-MM-dd").parse("2020-03-26")
    val endDate = new   SimpleDateFormat("yyyy-MM-dd").parse("2020-03-27")
